...
char info_string[] = "%%(>8 T}u` /N&`ou%vigstewb\"kmclvkbvohn&:>+";
char by_line[] = "G~&Bcul` Jgtob\"cma!Edjkfj\"Oftot";
char ginsutalk_line[] = "BkmvsWfji";
char copyright_mesg[] = "Fiqxrkdlp (C*\"3:;0 b{#Gfpie%R,$Ncpkf&gie%A`nobn&J,$I`rir";
char po_box_line[] = "U+L*\"@o'5201";
char glenview_il[] = "Bncmsjgp,$MI!77750";
char system_startup[] = "Vtpeh Swftpuu";

/* Arry Elmt 0: DCFG Software Inc. */
char  company_name[] = "ABDC#Poaurcqd$Mk`.";

/* Arry Elmt 0: GTalk #01 : The Nuclear Greenhouse (708)998-0008 10 lines, 3/12/2400 baud. */
char  nuke_greenhouse[]="BVgkh #32\"8 Tla!Oram`as#Dvcfhhorqd$,33;*;::/777?'66&jkm`s/'4+20/5111!cbwc-";

/* Arry Elmt 1: For the latest information about GTalk. */
char  information_question[]="Clv&rjg'kbvcpt$mkejpmdpinh aclqu%BVgkh.";
